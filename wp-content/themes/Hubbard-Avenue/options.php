...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '30px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#1a1a1a'));
			...
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#1a1a1a'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fc3030'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fc3030'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#1a1a1a'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '25px', 'lineheight' => '30px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '27px', 'lineheight' => '34px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#1a1a1a'));
...
// ---------------------------------------------------------		
		...
		$options['authentication_info'] = array(
							"desc" => __( "Options for Login/out links in shop menu in header:", CURRENT_THEME ),
							"id" => "authentication_info",
							"type" => "info");

		$options['login_display_id'] = array( "name" => __( "Display login links?", CURRENT_THEME ),
					"desc" => __( "Display login links in the shop menu?", CURRENT_THEME ),
					"id" => "login_display_id",
					"std" => "yes",
					"type" => "radio",
					"options" => array(
		...
		$options[] = array( "name" => __( "User profile link.", CURRENT_THEME ),
		...
		$options[] = array( "name" => __( "Logoff link.", CURRENT_THEME ),
		...
		$options[] = array( "name" => __( "Registration link.", CURRENT_THEME ),
		...
		$options[] = array( "name" => __( "Authentication link (login).", CURRENT_THEME ),
		...
		$options[] = array( "name" => __( "Live Chat account ID.", CURRENT_THEME ),
					"desc" => __( "To enable Olark live chat enter your live chat account ID here. <a href='http://www.olark.com/?r=ad8fbsj2'>Get own account ID</a>", CURRENT_THEME ),
					"id" => "live_chat_id",
					"std" => "",
					"class" => "tiny",
					"type" => "text");	
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
