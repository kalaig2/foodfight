...
function elegance_widgets_init() {
	...
	// Location: the sidebar
	register_sidebar(array(
		'name'					=> __( "Header Sidebar", CURRENT_THEME ),
		'id' 						=> 'header-sidebar',
		'description'   => __( "Header Sidebar", CURRENT_THEME ),
		'before_widget' => '<div id="%1$s" class="header-sidebar">',
		'after_widget' => '</div>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	));
	...
	// Location: the sidebar
	register_sidebar(array(
		'name'					=> __( "Slider Widget Area", CURRENT_THEME ),
		'id' 						=> 'slider-widget-area',
		'description'   => __( "Slider Area", CURRENT_THEME ),
		'before_widget' => '<div id="%1$s" class="slider-area">',
		'after_widget' => '</div>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	));
