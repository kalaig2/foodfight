<?php
class mmi_Options_sliderbar extends mmi_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('mmi-opts-jquery-ui-css');
		
		wp_enqueue_script(
			'jquery-slider', 
			mmi_OPTIONS_URI.'fields/sliderbar/jquery.ui.slider.js', 
		...
		wp_enqueue_script(
			'mmi-opts-field-sliderbar-js', 
			mmi_OPTIONS_URI.'fields/sliderbar/field_sliderbar.js', 
