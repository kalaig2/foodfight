jQuery(document).ready(function($){
	...
	// add
	$('.mmi-add-tab').click(function(){
		
		// increase tabs counter
		var tabs_counter = $(this).siblings('.mmi-tabs-count');
	...
	// delete
	$('.mmi-remove-tab').click(function(e){
		e.preventDefault();
		
		// decrease tabs counter
		var tabs_counter = $(this).parents('td').children('.mmi-tabs-count');
		tabs_counter.val(tabs_counter.val()*1 - 1);
