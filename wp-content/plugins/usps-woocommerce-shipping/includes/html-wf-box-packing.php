<tr valign="top" id="packing_options">
	<td class="forminp" colspan="2" style="padding-left:0px">
		<strong><?php _e( 'Box Dimensions', 'wf-usps-woocommerce-shipping' ); ?></strong><br/>
		<style type="text/css">
		...
		<table class="usps_boxes widefat">
			<thead>
				<tr>
					...
					<th><?php _e( 'Length', 'wf-usps-woocommerce-shipping' ); ?> (in)</th>
					<th><?php _e( 'Width', 'wf-usps-woocommerce-shipping' ); ?> (in)</th>
					<th><?php _e( 'Height', 'wf-usps-woocommerce-shipping' ); ?> (in)</th>
					<th><?php _e( 'Inner Length', 'wf-usps-woocommerce-shipping' ); ?> (in)</th>
					<th><?php _e( 'Inner Width', 'wf-usps-woocommerce-shipping' ); ?> (in)</th>
					<th><?php _e( 'Inner Height', 'wf-usps-woocommerce-shipping' ); ?> (in)</th>
					<th><?php _e( 'Box Weight', 'wf-usps-woocommerce-shipping' ); ?> (lbs)</th>
					<th><?php _e( 'Max Weight', 'wf-usps-woocommerce-shipping' ); ?> (lbs)</th>
					<th><?php _e( 'Letter', 'wf-usps-woocommerce-shipping' ); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
					<th colspan="3">
						<a href="#" class="button plus insert"><?php _e( 'Add Box', 'wf-usps-woocommerce-shipping' ); ?></a>
						<a href="#" class="button minus remove"><?php _e( 'Remove selected box(es)', 'wf-usps-woocommerce-shipping' ); ?></a>
					</th>
					<th colspan="8">
						<small class="description"><?php _e( 'Items will be packed into these boxes based on item dimensions and volume. Outer dimensions will be passed to USPS, whereas inner dimensions will be used for packing. Items not fitting into boxes will be packed individually.', 'wf-usps-woocommerce-shipping' ); ?></small>
					</th>
				</tr>
			</tfoot>
			<tbody id="rates">
