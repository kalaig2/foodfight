...
if( !class_exists('WF_API_Manager') ){
	class WF_API_Manager {
		public function __construct( $product_id, $plugin_version, $plugin_slug, $server_url ){
		...
		private function wf_init(){
			...
			new WF_API_Manager_Software_Update( $upgrade_url, $plugin_name, $product_id, $api_key, $activation_email, $renew_license_url, $instance, $domain, $software_version, $plugin_or_theme, $text_domain, $extra );
